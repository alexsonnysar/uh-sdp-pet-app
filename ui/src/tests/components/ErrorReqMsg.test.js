...
import ErrorReqMsg from '../../components/ErrorReqMsg';

describe('<ErrorReqMsg /> Tests', () => {
  let mockCallBack;
  let shallowWrapper;
  ...
  beforeEach(() => {
    ...
    shallowWrapper = shallow(
      <ErrorReqMsg open errorMsg="Test Msg" handleClose={mockCallBack} />
    );
  });
  ...
  test('should render the ErrorReqMsg Component', () => {
