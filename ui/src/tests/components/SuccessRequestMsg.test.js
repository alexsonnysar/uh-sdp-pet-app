...
import SucccessRequestMsg from '../../components/SuccessRequestMsg';

describe('<SuccessRequestMsg /> Tests', () => {
  let mockCallBack;
  let shallowWrapper;
  ...
  beforeEach(() => {
    ...
    shallowWrapper = shallow(
      <SucccessRequestMsg open successMsg="Test Msg" handleClose={mockCallBack} />
    );
  });
